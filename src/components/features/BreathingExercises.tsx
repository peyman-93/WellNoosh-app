...
export function BreathingExercises({ 
  ...
  const startBreathingSession = () => {
    // Add 3 second countdown before starting
    setBreathingState({
      isActive: true,
      currentPhase: 'inhale',
      timeLeft: 3, // Start with 3 second countdown
      cycleCount: 0,
      totalTime: 33 // Add 3 seconds to total time
    })
    
    // After 3 seconds, start the actual breathing pattern
    setTimeout(() => {
      setBreathingState(prev => ({
        ...prev,
      ...
      <View style={styles.startScreenContainer}>
        <View style={styles.startScreenContent}>
          ...
          <View style={styles.startButtonsContainer}>
            <Pressable style={styles.laterButton} onPress={onStartGuide}>
